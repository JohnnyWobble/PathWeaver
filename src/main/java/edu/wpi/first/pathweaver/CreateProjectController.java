...
public class CreateProjectController {
	...
	private void initialize() {
		...
		robotWidthControls.forEach(
				control -> control.setTooltip(new Tooltip("Overall width of the robot")));
		robotLengthControls.forEach(
				control -> control.setTooltip(new Tooltip("Overall length of the robot")));
	...
	private void createProject() {
		...
		ProjectPreferences.Values values = new ProjectPreferences.Values(lengthUnit, exportUnit, velocityMax, accelerationMax, trackWidthDistance, robotWidthDistance, robotLengthDistance, game.getValue().getName(), outputPath);
